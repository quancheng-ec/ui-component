<template>
  <div class="form-group">
    ...
    <div v-if="editableStatus">
      <div :class="{'input-group':$slots.addon}">
        ...
        <input v-if="!multiLine" class="form-control" :readonly="readonly" :disabled="disabled"
               ...
               :type="type" :value="value" @keyup.enter="editableStatus = false"
    ...
    <div class="form-control diseditabled" @mouseenter="editableBtnShow = true" @mouseleave="editableBtnShow = false"
         v-else>
